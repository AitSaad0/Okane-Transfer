...
public interface AgenceRepository extends JpaRepository<Agence, Long> {
    ...
    @Query("""
        ...
        WHERE t.agenceEnvoi.id = :agenceId
          ...
          AND t.statut <> com.okane.shared.StatutTransfert.ANNULE
    """)
    ...
    @Query("""
        ...
        WHERE t.agencePaiement.id = :agenceId
          ...
          AND t.statut = com.okane.shared.StatutTransfert.PAYE
    """)
    ...
    Long countByStatut(@Param("agenceId") Long agenceId,
                       @Param("statut") com.okane.shared.StatutTransfert statut);
